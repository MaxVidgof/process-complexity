...
first_weekday = first_timestamp - Complexity.relativedelta(days=first_timestamp.weekday())
start_timestamp = Complexity.datetime(first_weekday.year, first_weekday.month, first_weekday.day, 0, 0, 0, tzinfo=None)
end_timestamp = last_timestamp.replace(tzinfo=None)

if args.verbose:
	print("Overall time range: from "+"week "+str(first_weekday.isocalendar()[1])+" of "+str(first_weekday.year)+" to "+"Week "+str(last_timestamp.isocalendar()[1])+" of "+str(last_timestamp.year))
...
# Iterate over every week in log
for dt in rrule.rrule(rrule.WEEKLY, dtstart=start_timestamp, until=end_timestamp):
	# Filter PM4Py log
	filtered_pm4py_log = timestamp_filter.filter_traces_intersecting(pm4py_log, dt, dt+Complexity.relativedelta(weeks=1))
	...
	if len(filtered_pm4py_log)==0:
		continue
	# Print number of cases in this week
	if(args.verbose or DEBUG):
		# isocalendar[1] is number of week
		# change to isocalendar().week if upgraded to python 3.9
		print("Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(len(filtered_pm4py_log))+" cases")
	...
	if(args.verbose):
		print("Number of simple cycles in "+"week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(total_simple_cycles))
		print("Average number of simple cycles per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_simple_cycles))
		print("Median number of simple cycles per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_simple_cycles))
		print("Number of activity repetitions in "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(total_activity_repetitions))
		print("Average number of activity repetitions per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_activity_repetitions))
		print("Median number of activity repetitions per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_activity_repetitions))
	...
	if(args.verbose):
		print("Variant entropy: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(var_ent))
	...
	if(args.verbose):
		print("Sequence entropy: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(seq_ent))
	...
	if(args.verbose):
		print("Sequence entropy with linear forgetting: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(seq_ent_lin))
	...
	if(args.verbose):
		print("Sequence entropy with exponential forgetting (k="+str(args.ex_k)+")"+": "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(seq_ent_exp))
	...
	if(args.verbose):
		print("Median case duration: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_time)+" seconds")
		print("Average case duration: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_time)+" seconds")
		print("Median cycle time: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_cycle_time)+" seconds")
		print("Average cycle time: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_cycle_time)+" seconds")
	...
	if(args.verbose):
		print("HERE")
		print("Number of participants in "+"week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(total_resources))
		print("Average number of participants per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_resources))
		print("Median number of participants per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_resources))
		print("Number of work handovers in "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(total_handovers))
		print("Average number of work handovers per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_handovers))
		print("Median number of work handovers per trace: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_handovers))
		print("Average number of work handovers from participant: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(avg_from_handovers))
		print("Median number of work handovers from participant: "+"Week "+str(dt.isocalendar()[1])+" of "+str(dt.year)+": "+str(median_from_handovers))
...
if(args.save_plots):
	save_figures(variant_entropy, "Weekly_Variant_Entropy")
	save_figures(sequence_entropy, "Weekly_Sequence_Entropy")
	save_figures(sequence_entropy_linear, "Weekly_Sequence_Entropy_Linear")
	save_figures(sequence_entropy_exponential, "Weekly_Sequence_Entropy_Exponential")
...
if(args.save_csv):
	...
	df_merged.to_csv(base_filename+"_metrics_weekly.csv", index=False)
